...
class MainWindow(QMainWindow):
    ...
    def show_new(self):
        ...
        #subprocess.Popen(['python',r"./SolarSystem_Final.py"])
        global ursina_start
        ursina_start=True
        self.close()
...
while True:
    ...
    if ursina_start==True:
        app=Ursina(title='Project Shunya', icon=r'../Assets/Solar-system.ico',render_mode='onscreen' )
        #print('HIIIIIIIIIIIIIIIIII:::::::    ',type(window))
        window.size=Vec2(1090,582)
        ...
        def update():
            ...
            if not ursina_start:
                if window.size!=Vec2(1,1):
                    ...
                    #print([window.size,type(window.size)])
                else:    
                    raise SystemExit()
            else:   
