...
def input(key):
    ...
    #
        ...
        if toggle_trail==True:
            ...
            global curve_renderer_titan,curve_renderer_rhea,curve_renderer_titania,curve_renderer_triton                            #change
            try:
...
def update():
    ...
    global sun_text,mercury_text,venus_text,earth_text,moon_text,rhea_text              #change
    global mars_text,jupiter_text,ganymede_text,saturn_text,callisto_text,triton_text   #change
    global uranus_text,neptune_text,pluto_text,io_text,europa_text,titan_text           #change
