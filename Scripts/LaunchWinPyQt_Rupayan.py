...
class MainWindow(QMainWindow):
    ...
    def show_about(self):
        #self.dialog.RM.setText("<a href=\'https://www.linkedin.com/in/rupayanmandal/'><font face=MS Sans Serif size=4 color=white> Rupayan Mandal </a>")
        #self.dialog.SS.setText("<a href=\'https://www.linkedin.com/in/satyaki-saha-550224244/'><font face=MS Sans Serif size=4 color=white>Satyaki Saha</a>")
        #self.dialog.AB.setText("<a href=\'https://www.linkedin.com/in/atreyee-bandyopadhyay-672825205/'><font face=MS Sans Serif size=4 color=white>Atreyee Bandyopadhyay</a>")
        #self.dialog.Coffee.setIcon(QIcon("..\\Assets\\coffee.jpg"))
