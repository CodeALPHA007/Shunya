...
url="https://shunyathespaceapp.onrender.com/public/version.txt"
try:
    coneection_check = requests.get('https://www.google.com/', timeout=6)
    cur_version_req=requests.get(url)
...
<red>Enable mouse associated movement :</red><green> M / m</green>
