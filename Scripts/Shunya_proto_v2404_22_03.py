...
app=Ursina(title='Project Shunya', icon=r'../Assets/Solar-system.ico',render_mode='onscreen',forced_aspect_ratio=2)
...
while True:
    ...
    if ursina_start==True:
        ...
        """ print('dddddddddddddddddddddddddddddddddddddddddddddddddddddddddd', window.size)
        for i in app.win.getDisplayRegions():
            print([i,i.getCamera()]) """
        ...
        #app.exitFunc=ursina_my_window_exit    
        window.exit_button.on_click=ursina_my_window_exit  
        i=0
        ...
        def update():
            global ursina_start,app,temp,i

            if not ursina_start:
                """ if window.size!=Vec2(1,1):
                    #window.size=Vec2(1,1)
                    #myapp.graphicsEngine.removeAllWindows()
                    #temp=myapp.win
                 """    
